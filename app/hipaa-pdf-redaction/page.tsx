...
export const metadata = {
  ...
  description:
    'Redact health information from PDFs in your browser with verified export and no document upload to OnlineRedactor servers.',
};
...
export default function HipaaPdfRedactionPage() {
  return (
    <UseCasePage
      ...
      intro="Redact patient identifiers and other sensitive health information locally in your browser before sharing a PDF."
      steps={[
        'Open the PDF in the browser-only redactor.',
        'Use search, auto-detect, or manual boxes to mark patient identifiers.',
        'Export only after verification confirms the selected extractable text is gone.',
      ]}
      notes={[
